...
From inside this directory (`example-route-slot/`), copy the template:
...
After installation, open your project in the Dataloop console and look for the new icon in the left sidebar.
